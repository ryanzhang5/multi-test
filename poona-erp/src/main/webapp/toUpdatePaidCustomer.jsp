...
<body>
<form id="updatePaidForm" method="post">
<table style="width:100%">
 <tr>
  <td>姓名</td> <td><s:property value="customer.name"/><input type="hidden" name="customerId" value='<s:property value="customer.id"/>'/></td>
  </tr>
   <tr>
  <td>购买次数</td> <td><s:property value="customer.buyTimes"/></td>
  </tr>
   <tr>
  <td>剩余次数</td> <td><input type="text" name="leftTimes" value='<s:property value="customer.leftTimes"/>'/></td>
  </tr>
  <tr>
  <tr>
